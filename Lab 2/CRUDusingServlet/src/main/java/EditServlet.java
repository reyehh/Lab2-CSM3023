...
public class EditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<tr><td></td><td><input type='hidden' name='id' value='"
                +e.getId()+"'/></td></tr>");
        out.print("<tr><td></td><td><input type='hidden' name='username' value='"
                +e.getUsername()+"'/></td></tr>");
        out.print("<tr><td></td><td><input type='hidden' name='password' value='"
                +e.getPassword()+"'/></td></tr>");
        ...
        out.print("</select>");
        out.print("</td><tr>");
        out.print("<tr><td colspan='2'><input type='submit' walue'Edit & Save '/></td></tr>");
        out.print("</table>");
        out.print("</form>");
